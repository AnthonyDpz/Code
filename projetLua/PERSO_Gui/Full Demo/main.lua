...
local mainFont = love.graphics.newFont("Font/kenvector_future_thin.ttf", 15)
...
function love.load()
  ...
  love.graphics.setBackgroundColor(63, 124, 182)
  ...
  buttonYes:setImages(
    love.graphics.newImage("images/Button/button_default.png"),
    love.graphics.newImage("images/Button/button_hover.png"),
    love.graphics.newImage("images/Button/button_pressed.png")
    )
  ...
  panelTest1:setImage(love.graphics.newImage("images/Panel/panel1.png"))
  panelTest1:setEvent("hover", onPanelHover)

  panelTest2 = myGUI.newPanel(350, 250)
  panelTest2:setImage(love.graphics.newImage("images/Panel/panel2.png"))
...
function love.update(dt)
  ...
  if progressTest1.Value >= 0.1 then
    progressTest1:setValue(progressTest1.Value - 0.1)
  end
  if progressTest2.Value <= 100 then
    progressTest2:setValue(progressTest2.Value + 0.1)
  end
